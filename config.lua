...
Config.ExcludeAccountsList = {"bank","star"} -- List of accounts names to exclude from inventory
Config.OpenControl = 289 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.
Config.MaxWeight = 45 --SAME AS THE DEFAULT ON ES EXTENDED CONFIG
...
Config.Shops = {
    RegularShop = {
        Locations = {
            { x = -1483.83, y = -32.41, z = 54.61 },
            { x = -803.66, y = 185.13, z = 72.61 },
        ...
        Items = {
            ...
            { name = 'fishbait', price = 2000 },
            { name = 'turtlebait', price = 5000 },
            { name = 'lighter', price = 5000 },
            { name = 'fixkit', price = 10000 },
            { name = 'updateweapon_1', price = 50000 },
            { name = 'updateweapon_2', price = 70000 },
            { name = 'updateweapon_3', price = 100000 },
        },
    },
    ...
    PoliceShop = {
        Locations = {
            ...
            { x = 1849.2, y = 3688.12, z = 34.27 },
        },

        Items = {
            { name = "WEAPON_STUNGUN", price = 0, ammo = 500},
            { name = "WEAPON_ADVANCEDRIFLE", price = 0, ammo = 500},
            -- { name = "WEAPON_BULLPUPRIFLE", price = 0,  ammo = 500},
            -- { name = "WEAPON_CARBINERIFLE", price = 0,  ammo = 500},
            { name = "WEAPON_APPISTOL", price = 0,  ammo = 500},
            { name = 'WEAPON_BZGAS', price = 0 ,  ammo = 10},
            { name = "bulletproof2", price = 0, ammo = 500},
            --[[ { name = "disc_ammo_pistol", price = 0}, ammo = 500,
            { name = "disc_ammo_rifle", price = 0, ammo = 500},
            { name = "disc_ammo_shotgun", price = 0, ammo = 500},
            { name = "disc_ammo_smg", price = 0, ammo = 500}, ]]
        },
    },
}
